...
/**
 * Semantic retrieval with LangChain4j (AC-005): query embedding -> similarity search -> relevant chunks.
 * Maps vector-store matches to {@link KnowledgeChunk}, so framework types do not leave this package.
 */
class LangChain4jKnowledgeRetriever implements KnowledgeRetriever {
